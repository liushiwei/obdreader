...
public class AboutSoftwareSetting extends PreferenceFragment {
        ...
        software_update.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                new Thread() {
                    ...
                    @Override
                    public void run() {
                        String responeString = Device.getHttpResponse(
            ...
            switch (msg.what) {
                case 0:
                    ...
                    if (respone != null) {
                        ...
                        String version = respone.substring(0, respone.indexOf('\n'));
                        new_version_name = version.trim().substring(version.indexOf(':') + 1,
                                version.length());
                        ...
                        if (current_version_name.compareTo(new_version_name) == 0) {
                            builder.setTitle(getString(R.string.no_new_verion));
                        } else {
                            builder.setTitle(String
                                    .format(getString(R.string.download_new_version), new_version_name));
                            ...
                            builder.setNegativeButton(android.R.string.ok, new OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    request.setAllowedNetworkTypes(
                                            ...
                                            .setTitle("ObdReader.apk") // 用于信息查看
                                            .setDescription(String
                                                    .format(getString(R.string.new_version), new_version_name)) // 用于信息查看
                                            .setDestinationInExternalPublicDir(
                                                    Environment.DIRECTORY_DOWNLOADS, "ObdReader"+new_version_name.replace('.', '_')+".apk");
    ...
    private void queryState(long downID) {
        ...
        if (c == null) {
            Toast.makeText(getActivity(), "Download not found!", Toast.LENGTH_LONG)
                    .show();
        } else { // 以下是从游标中进行信息提取
            if (!c.moveToFirst()) {
                c.close();
            ...
            //Toast.makeText(getActivity(), statusMessage(st), Toast.LENGTH_LONG).show();
