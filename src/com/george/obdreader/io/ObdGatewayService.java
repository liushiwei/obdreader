 ...
 * OBD Bluetooth interface. Secondarily, it will serve as a repository of
 * ObdCommandJobs and at the same time the application state-machine.
 */
public class ObdGatewayService extends Service {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case MESSAGE_STATE_CHANGE:
                    switch (msg.arg1) {
                        case ObdConnecter.STATE_CONNECTING:
                            if (_callback != null) {
    ...
    Runnable btConnectRunnable = new Runnable() {
        @Override
        public void run() {
