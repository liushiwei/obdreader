...
public class GaugeView extends View {
	...
	public static final float[] RANGE_VALUES = { 160.0f, 400.0f, 800.0f, 1500.0f };
	...
	public Paint getDefaultFacePaint() {
		...
		paint.setShader(new RadialGradient(0.5f, 0.5f, mFaceRect.width() / 2, new int[] { Color.rgb(13, 100 ,124), Color.rgb(5 ,62 ,76),
				Color.rgb(4, 50 ,62), Color.rgb(2 ,37 ,46),Color.rgb( 2  ,34 , 42) }, new float[] {0.3f, 0.6f,0.8f, 0.96f, 0.99f }, TileMode.MIRROR));
		return paint;
	}
	...
	private void initScale() {
		...
		Log.e(TAG, "mScaleRotation ="+mScaleRotation);
		Log.e(TAG, "mDivisionValue ="+mDivisionValue);
		Log.e(TAG, "mSubdivisionValue ="+mSubdivisionValue);
		Log.e(TAG, "mSubdivisionAngle ="+mSubdivisionAngle);
		Log.e(TAG, "mScaleEndValue ="+mScaleEndValue);
		Log.e(TAG, "mScaleStartValue ="+mScaleStartValue);
		Log.e(TAG, "mDivisions ="+mDivisions);
	}
	...
	private void drawDialPlate(final Canvas canvas) {
		if (null == mBackground) {
		}
		else {
	...
	private void computeCurrentValue() {
		...
		if (!(Math.abs(mCurrentValue - mTargetValue) > 0.01f)) { return; }
